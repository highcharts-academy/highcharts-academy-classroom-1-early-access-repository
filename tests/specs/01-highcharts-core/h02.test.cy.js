describe("02-create-series-tests", () => {
  beforeEach(() => {
    ...
    cy.visit(
      "../../../exercises/01-highcharts-core/02-create-series/index.html"
    );
  });
  ...
  it("should verify the line series data", () => {
    cy.window()
      ...
      .then((Highcharts) => {
        ...
        expect(
          lineDataValues,
          "Line series data should match expected values"
  ...
  it("should verify the spline series data", () => {
    cy.window()
      ...
      .then((Highcharts) => {
        ...
        expect(
          splineDataValues,
          "Spline series data should match expected values"
